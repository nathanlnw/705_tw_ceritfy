...
{
       JT808Conf_struct.DURATION.Heart_Dur=90;       // 心跳包发送间隔
	...
	JT808Conf_struct.DURATION.UDP_ReSD_Num=5;     //  UDP 重发次数
 	...
 	JT808Conf_struct.DURATION.Sleep_Dur=300;  //300     //  休眠时上报的时间间隔     
...
u8     JT808_Conf_init( void ) 
  {
		...
		//--------------------------------------------------------------------------
		  JT808Conf_struct.Driver_Info.BD_IC_status=0x00;   
		  memcpy(JT808Conf_struct.Driver_Info.BD_IC_inoutTime,"\x13\x01\x01\x01\x30\x30",6);   
		  JT808Conf_struct.Driver_Info.BD_IC_rd_res=0x03;   //卡片被拔出
		  JT808Conf_struct.Driver_Info.BD_DriveName_Len=4; //  姓名长度
		  memcpy(JT808Conf_struct.Driver_Info.BD_DriveName,"未知",4); 
		  memcpy(JT808Conf_struct.Driver_Info.BD_Drv_CareerID,"00000000000000000000",20); //  从业资格证编码
...
void DefaultConfig(void)
{
  ...
  if(JT808Conf_struct.Regsiter_Status)
	  ...
	  //   里程
         ...
         rt_kprintf("\r\n		  驾驶员姓名: %s \r\n",JT808Conf_struct.Driver_Info.BD_DriveName); 					  
         rt_kprintf("\r\n		  驾驶员从业资格证: %40s \r\n",JT808Conf_struct.Driver_Info.BD_Drv_CareerID); 
         rt_kprintf("\r\n		  发证机构: %s \r\n",JT808Conf_struct.Driver_Info.BD_Confirm_agentID);    
